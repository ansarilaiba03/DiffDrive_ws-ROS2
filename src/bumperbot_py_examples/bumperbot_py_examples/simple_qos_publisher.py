...
class SimpleQosPublisher(Node):
    def __init__(self):
        ...
        if reliability == "best_effort":
            ...
            self.get_logger().info("[Reliable] : Reliable")
            ...
            self.get_logger().error("Selected Reliability QoS: %s dosen't exists" % reliability)
            return
        ...
        if durability == "volatile":
           ...
           self.get_logger().error("Selected Durability QoS: %s dosen't exists" % durability)
           return
